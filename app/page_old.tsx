...
import CharacterGeneration from "@/components/steps/CharacterGeneration";
import PDFDownload from "@/components/steps/PDFDownload";
import ProgressBar from "@/components/ui/ProgressBar";
import StepIndicator from "@/components/ui/StepIndicator";

const steps = [
  { id: "form", title: "Story Details", icon: BookOpen },
  { id: "upload", title: "Upload Photo", icon: Wand2 },
  { id: "generate", title: "Generate Character", icon: Sparkles },
  { id: "download", title: "Download Book", icon: Download },
];
